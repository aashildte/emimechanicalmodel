...
class EMIModelCollagen(CardiacModel):
    """

    Module for our EMI model with detailed ECM structure, including different subdomains
    for the endomysium (volume ID 1) and perimysium (volume ID 2), collagen distribution,
    as well as the usual cell structures.
    ...
    def set_subdomains(self, mesh, volumes):
        ...
        self.volumes = volumes_binary  # intra- or extra-cellular only
