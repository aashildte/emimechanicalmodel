...
Implementation of a multidomain model; mostly defined through heritage.

Whatever is marked with '0' is assumed to be non-contractile, otherwise
material properties are determined explicitly through the material parameters.
...
class FibrosisModel(CardiacModel):
    """
